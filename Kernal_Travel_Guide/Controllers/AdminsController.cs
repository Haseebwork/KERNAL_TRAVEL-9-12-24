...
namespace Kernal_Travel_Guide.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(KernalTravelGuideContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admins != null ? 
                          ...
                          Problem("Entity set 'Kernal_Travel_GuideContext.Admin'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Kernal_Travel_GuideContext.Admin'  is null.");
            }
            var admin = await _context.Admins.FindAsync(id);
            if (admin != null)
            {
